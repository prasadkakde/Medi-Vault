...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (role === "admin")
       endpoint = "https://medi-vault-wf7o.onrender.com/api/admin/login";

      if (role === "doctor")
       endpoint = "https://medi-vault-zmx6.onrender.com/api/doctors/login";

      if (role === "patient")
       endpoint = "https://medi-vault-zmx6.onrender.com/api/patients/login";
